...
export default function HomePage() {
	...
	return (
		<main className="flex-1 flex">
            ...
            <div className="flex flex-col gap-4 px-8 py-4 w-[40rem] bg-[#B5E7ED]">
                <Logo />

                <Separator />

                <div className="divide-y flex flex-col p-2">
                    {drones.map((drone) => (
                        <div key={drone.id}>
                            <MotionCard
                                initial={false}
                                        ...
                                        >
                                            ...
                                            <div className="flex gap-2">
                                                <Button
                                                    ...
                                                    onClick={() => {
                                                        selectDrone(null);
                                                        if (map && map.getZoom() >= 18) map?.zoomTo(17.5);
                                                    }}
                                                >
                                                    Back
                                                </Button>
                                                ...
                                                {drone.overriten && (
                                                    <Button
                                                        variant="destructive"
                                                        onClick={() => send({ type: "stop_override", drone: drone.id })}
                                                    >
                                                        Resume scan
                                                    </Button>
                                                )}
